...
<script type="text/javascript" src="<c:url value='/resources/public/js/jquery.isotope.min.js'/>" ></script> 
<script type="text/javascript" src="<c:url value='/resources/public/js/jquery.gmap.min.js'/>" ></script> 
<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false" ></script>
<script type="text/javascript" src="<c:url value='/resources/public/rs-plugin/js/jquery.themepunch.plugins.min.js'/>" ></script> 
<script type="text/javascript" src="<c:url value='/resources/public/rs-plugin/js/jquery.themepunch.revolution.min.js'/>" ></script> 
