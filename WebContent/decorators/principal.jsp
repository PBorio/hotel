								...
								<ul class="recent-posts">
									<li>
										<div class="user-thumb">
											<img width="40" height="40" alt="User" src="<c:url value='/resources/imagens/demo/av2.jpg'/>"/>
										</div>
									...
									<li>
										<div class="user-thumb">
											<img width="40" height="40" alt="User" src="<c:url value='/resources/imagens/demo/av3.jpg'/>" />
										</div>
										<div class="article-post">
									...
									<li>
										<div class="user-thumb">
											<img width="40" height="40" alt="User" src="<c:url value='/resources/imagens/demo/av1.jpg'/>"/>
										</div>
										<div class="article-post">
